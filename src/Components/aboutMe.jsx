        ...
        return (
            <div className="landing-box" id="about-me">
                ...
                <div className="description-container">
                    <p id="description">So, while trying to find the best description of myself, I had this idea that I could write a few words about me in a +/- comparison, or The +, But – self description. So here it is.
                    ...
                    <br></br>
                    <p id="description">Nobody’s perfect, everyone has their flaws. I think that knowing the + and the – about yourself is absolutely crucial both in your personal and professional life. Sometimes it’s about accepting the -, not correcting it. Or to focus on the +, even if the – exists. So this me.</p>
                </div>
            </div>
        )
    }
